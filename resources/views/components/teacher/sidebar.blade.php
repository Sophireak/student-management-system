...
>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
        ...
        <x-admin.nav-item route="teacher.reports.ranking.index" icon="📊" label="Ranking Report" />
        <x-admin.nav-item route="teacher.reports.honors.index"  icon="🏅" label="Honors Report" />
