...
>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
        ...
        <x-admin.nav-item route="teacher.student-attendance.index" icon="ti ti-calendar-check" label="Student Attendance" />

        <div class="pt-4 pb-1 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Scores</div>
        <x-admin.nav-item route="teacher.examination-scores.index" icon="ti ti-clipboard-list" label="Examination Scores" />

        <div class="pt-4 pb-1 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Reports</div>
        <x-admin.nav-item route="teacher.reports.ranking.index" icon="ti ti-chart-bar" label="Ranking Report" />
        <x-admin.nav-item route="teacher.reports.honors.index"  icon="ti ti-trophy" label="Honors Report" />
    </nav>
