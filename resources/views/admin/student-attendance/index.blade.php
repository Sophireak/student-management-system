@extends('layouts.admin', ['title' => 'វត្តមានសិស្ស'])
            ...
            @foreach ($enrollments as $i => $enrollment)
                ...
                <div class="bg-white rounded-2xl border shadow-sm p-4 transition-all"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="w-11 h-11 rounded-full overflow-hidden flex items-center justify-center 
                        ...
                        <div class="flex items-center gap-1 flex-shrink-0">
                            <button @click="setStatus('{{ $enrollment->id }}', 'present')"
                                    :disabled="isLocked"
                            ...
                            <button @click="setStatus('{{ $enrollment->id }}', 'absent')"
                                    :disabled="isLocked"
                            ...
                            <button @click="setStatus('{{ $enrollment->id }}', 'late')"
                                    :disabled="isLocked"
                            ...
                            <button @click="setStatus('{{ $enrollment->id }}', 'excused')"
                                    :disabled="isLocked"
...
@push('scripts')
<script>
    // Sync save bar with sidebar toggle state
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function syncSaveBar() {
            ...
            saveBar.style.marginLeft = isCollapsed ? '72px' : '240px';
        }
