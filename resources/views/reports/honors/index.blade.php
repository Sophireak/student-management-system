...
<div class="mb-6">
    <h2 class="text-lg font-semibold text-gray-700">Honors Report</h2>
    <p class="text-sm text-gray-400 mt-0.5">
        Select class and period to view top-ranked students.
    </p>
</div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-xl">
    <form method="GET" action="{{ route($routePrefix . '.reports.honors.sheet') }}">
        ...
        <div class="mb-6">
            <label class="block text-sm font-medium text-gray-700 mb-1">Top N Students</label>
            <select name="top"
                    class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm
                           focus:outline-none focus:ring-2 focus:ring-blue-400">
