@extends('layouts.teacher', ['title' => 'Ranking Report — ' . $class->name])
...
<div class="mb-4 flex items-center justify-between flex-wrap gap-2">
    <div>
        <a href="{{ route($routePrefix . '.reports.ranking.index') }}"
           class="text-sm text-blue-600 hover:underline">← Ranking Report</a>
...
@else
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-x-auto print:shadow-none print:border-0">
